...
def create_top_frame(window, grid, board):
    ...
    create_project_name_button(top_frame, grid, board)
    return top_frame
...
def create_project_name_button(top_frame, grid, board):
    #new game button, middle left
    def _start_new_game(g=grid, b=board):
        handlers.start_new_game(grid, board)

    newgame_button = tk.Button( top_frame, bd=1, width=15, text="Project Minesweeper",
